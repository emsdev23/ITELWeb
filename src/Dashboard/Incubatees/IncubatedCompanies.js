      ...
      <div className="compnaies-list">
        ...
        <div className="company-description">
          ...
          <p className="company-desc">
            ...
            rugged, autonomous quadruped robots with advanced AI, that go beyond
            conventional limitations, offering robust, dynamic, and adaptable
      ...
      <div className="compnaies-list">
        ...
        <div className="company-description">
          ...
          <p className="company-desc">
            ...
            solutions. Our goal is to help people across India overcome language
            challenges using AI for Speech and Text. They use Compute power of
            handset for speech-to-text and text-to-speech conversion for Indian
            languages, rather than using GPUs on Cloud , saving costs and power.
          </p>
          <div className="company-website">
            <div>
      ...
      <div className="compnaies-list">
        ...
        <div className="company-description">
          ...
          <p className="company-desc">
            ...
            assessment and support through cutting-edge technology. Our mission
            is to provide accessible, convenient, and effective solutions that
            empower individuals on their mental wellness journey.
          </p>
          <div className="company-website">
            <div>
...
export default IncubatedCompanies;
