      ...
      <div className="description">
        ...
        <div>
          <p>
            ...
            get worse, with about 350 million vehicles expected in Indian cities
            by 2050, as opposed to 101 million vehicles now.{" "}
          </p>
          ...
          <div>
            ...
            <p>
              HASHTIC involves personalized PODS that provide a transport which
              is:{" "}
            </p>
            <ul>
              <li>Comfortable</li>
          ...
          <div>
            ...
            <p>
              ...
              Today, most goods are carried on trucks (Goods transport by Indian
              Railways is only about 18% of the total), and it takes four to
              five days when transported across India. It is believed that CO2
              emissions from freight transport are likely to increase by 451% by
              2050.
            </p>
            <ul>
              ...
              <li>
                The battery required would be too large. Will they be driven by
                Green Hydrogen?{" "}
              </li>
              ...
              <li>
                Can the goods really be delivered across the country in 24 hours
                if electric trucks are used?
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              autonomous Wagons instead of trucks, travelling at about 200 kmph
              on special rails. The rail network could be built at a height on
              existing highways, driven by green electricity and consuming a
              minimum amount of energy, as the wagons would be cascaded to
              minimize aerodynamic resistance.
            </p>
            ...
            <p>
              ...
              congestion. The Network will be from a grid of 100 km×100 km with
              stations at each cross-point, from where the goods will be moved
              by electric trucks to their final destinations.
            </p>
            <p>
